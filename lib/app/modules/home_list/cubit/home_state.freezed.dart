    ...
    return _then(_value.copyWith(
      listInfo: freezed == listInfo
          ...
          : listInfo // ignore: cast_nullable_to_non_nullable
              as List<InfoModel>?,
      showingList: freezed == showingList
          ? _value.showingList
      ...
      isLoading: null == isLoading
          ...
          : isLoading // ignore: cast_nullable_to_non_nullable
              as bool,
      errorConnect: freezed == errorConnect
          ? _value.errorConnect
          : errorConnect // ignore: cast_nullable_to_non_nullable
              as String?,
      filter: null == filter
          ? _value.filter
...
class _$HomeStateImpl extends _HomeState {
  ...
  final List<InfoModel>? _showingList;
  @override
  List<InfoModel>? get showingList {
    final value = _showingList;
    if (value == null) return null;
    if (_showingList is EqualUnmodifiableListView) return _showingList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.errorConnect, errorConnect) ||
                other.errorConnect == errorConnect) &&
